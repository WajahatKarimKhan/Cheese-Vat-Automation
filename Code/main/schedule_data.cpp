...
Schedule pasteurizationSchedule = {"Pasteurization", "00/00/00", "00:00", 0, 0};
Schedule cheeseMakingSchedule   = {"Cheese Making",  "00/00/00", "00:00", 0, 0};
Schedule coolingSchedule        = {"Cooling",        "00/00/00", "00:00", 0, 0};
Schedule cheeseDrainageSchedule = {"Cheese Drainage","00/00/00", "00:00", 0, 0};
Schedule waterDrainageSchedule  = {"Water Drain",    "00/00/00", "00:00", 0, 0};
Schedule waterRefillSchedule    = {"Water Refill",   "00/00/00", "00:00", 0, 0};
Schedule milkRefillSchedule     = {"Milk Refill",    "00/00/00", "00:00", 0, 0};
...
bool hasRunToday = false;  // Could be moved to a per-schedule flag
