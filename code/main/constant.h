...
#define _SET_HOUR   16  //Default hour to set in RTC (24-hour format).
#define _SET_MIN    10   //Default minute to set in RTC.
#define _SET_SEC    46   //Default second to set in RTC.
