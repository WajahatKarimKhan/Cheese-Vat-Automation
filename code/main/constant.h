...
#define _SET_DAY 21     //Default day of the month to set in RTC. 
...
#define _SET_MIN 44     //Default minute to set in RTC.
#define _SET_SEC 38     //Default second to set in RTC.
#define _SET_WEEK_DAY 1  // Default day of week (1=Monday, 7=Sunday)
