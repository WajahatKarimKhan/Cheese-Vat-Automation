...
#define _SET_DAY    7   //Default day of the month to set in RTC. 
#define _SET_MONTH  8   //Default month to set in RTC.
#define _SET_YEAR   25  //Default year (2-digit format) to set in RTC.
#define _SET_HOUR   10  //Default hour to set in RTC (24-hour format).
#define _SET_MIN    34   //Default minute to set in RTC.
#define _SET_SEC    45   //Default second to set in RTC.
#define _SET_WEEK_DAY 4  // Default day of week (1=Monday, 7=Sunday)
...
#define MILK_EMPTY_THRESHOLD    10    // empty % milk  level
#define WATER_EMPTY_THRESHOLD   10    // empty % water level

// =================  GUI Section ===================

enum InputFieldSchedule { NONE, DATE, TIME };
enum InputFieldPRG { NONE_PRG, TARGET_TEMP, STIR_SPEED_HEATING, STIR_DIR_HEATING, STIR_SPEED_HOLDING, STIR_DIR_HOLDING, HOLD_TIME, TARGET_COOL_TEMP, TARGET_MILK_REFILL} ;
