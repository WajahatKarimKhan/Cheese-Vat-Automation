        ...
        */
        ...
        case PAST_PHASE_HEATING: 
            ...
            if (readTEMP(TEMP_SENSOR_1) >= past_params.targetTemp) {
                ...
                stopHeater();
                //stopStirrer(stirrer);
                //holdStart = millis(); //will probably use for the rods on duration
        ...
        case PAST_PHASE_HOLDING: {
            ...
            if ((millis() - holdStart) >= (past_params.holdTime * 60000UL)) {
    ...
    switch (cmPhase){
        ...
        */
        ...
        case CM_PHASE_HOLDING: {
            ...
            // Check if holding time is complete FIRST
            if ((millis() - holdStart) >= (cm_params.holdTime * 60000UL)) {
                println("Holding done. Start cooling...");
                stopHeater();
